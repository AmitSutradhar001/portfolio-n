...
const Hero = () => {
  ...
  // useMotionVlue HOOK dosen't rerender the page like the useState. It's use in high animation web pages.

  const handleMouseMove = (e) => {
    const { clientX, clientY } = e; // cordinats for x and y (mouse).
    x.set(clientX); // set x value
    y.set(clientY); // set y value
  };
      ...
      <div>
        ...
        >
          ...
          >
            ...
            />
            <motion.span
              className="absolute text-3xl font-semibold text-teal-600/65"
              initial={{ scale: 0 }}
              animate={{
